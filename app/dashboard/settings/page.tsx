  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-blue-50 via-indigo-100 to-purple-200 p-10'>
      <div className='max-w-7xl mx-auto bg-white rounded-lg shadow-2xl p-8'>
        ...
        <p className='text-lg text-gray-700 mb-8 max-w-2xl'>Customize your account settings, profile, and notifications here. Choose an option from the sidebar to begin</p>
        <div className='flex space-x-12'>
          <div className='w-1/4 bg-white rounded-lg p-6 space-y-6'>
            ...
            <ul className='space-y-4'>
              ...
              <li>
                <Link className='flex items-center text-lg text-gray-800 hover:text-yellow-600 transition-colors py-2 px-4 rounded-md hover:bg-yellow-50' href='/dashboard/settings/notification'>
          ...
          <div className='flex-1 bg-white shadow-md rounded-lg p-8'>
            ...
            <p className='text-lg text-gray-600 max-w-3xl'>Choose an option from the sidebar to manage your account, notification or profile settings</p>
          </div>
        </div>
      </div>
    </div>
