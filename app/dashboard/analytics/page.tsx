  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-50 to to-blue-50 p-8'>
      <div className='max-w-7xl mx-auto bg-white rounded-lg shadow-xl p-8'>
        ...
        {/* Recent Activities */}
        <div className='mb-8'>
          <h2 className='tet-xl font-semibold text-gray-700 mb-4'>Recent Activities</h2>
          <ul className="space-y-4">
            <li className='flex items-center justify-between bg-white rounded-lg shadow-md p-4'>
              <div>
                ...
                <p className="text-sm text-gray-600">New user signed up 2025-04-02</p>
              </div>
            ...
            <li className='flex items-center justify-between bg-white rounded-lg shadow-md p-4'>
              <div>
                ...
                <p className="text-sm text-gray-600">Sales grew by 12% on 2025-04-02</p>
              </div>
              <div className='text-sm text-gray-600'>
            ...
            <li className='flex items-center justify-between bg-white rounded-lg shadow-md p-4'>
              <div>
                ...
                <p className="text-sm text-gray-600">Traffic increased by 8% on 2025-04-02</p>
              </div>
              <div className='text-sm text-gray-600'>
